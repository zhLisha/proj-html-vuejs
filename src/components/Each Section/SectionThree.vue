...
.upcoming-events {
    ...
    .single-session {
        ...
        .btn {
            ...
            box-shadow: 1px 1px 5px rgba(187, 75, 75, 0.818);
            padding: 12px 25px;
        }
...
// ************************************
// MEDIA QUERY for year-program details
// ************************************
